...
export const Landing: React.FC = () => {
  ...
  const features = [
    { icon: Sparkles, title: 'AI-Powered Contents', description: 'Generate stunning social media posts, blog headers, and marketing content with AI.' },
    { icon: Target,   title: 'Visual Plannings',    description: 'Connect and organize your content with intuitive drag-and-drop node planning.' },
